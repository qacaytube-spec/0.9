...
/* ===== v1.0.8 JS SAFETY OVERRIDES ===== */
// Cavab seçəndə heç bir ekran/sual flash və screen-pop işləməsin.
flashScreen = function(type) { return; };
stagePulse = function(type) { return; };
// Nəticə yazısı qalsın, amma animasiyasız və qısa görünsün.
showResultLine = function(text, type="good") {
